...
public class Main {
    public static void main(String[] args){
        ...
        for(int e : Problem1.abgerundet(note))
            System.out.println(e);

        System.out.print("Sal");

        for(int e : Problem1.nichtAusreichend(note))
            System.out.println(e);

        System.out.println(Problem1.durchschnitt(note));

        System.out.println(Problem1.maxAbgerundet(note));

        int[] n1={1,9,1};
        int[] n2={2,2,2};
        int[]numere1={1, 3, 0, 0, 0, 0, 0, 0, 0};
        int[]numere2={8, 7, 0, 0, 0, 0, 0, 0, 0};
        System.out.println(Arrays.toString(Problem3.summeZahlen(n1,n2)));
...
//        int[] t2 = {8, 0, 0, 0, 0, 0, 0, 0, 0};
        ...
        System.out.println(Arrays.toString(Problem3.sum(t1, t2)));
        System.out.println();

        System.out.print("t1 - t2 = ");
        System.out.println(Arrays.toString(Problem3.diff(t1, t2)));
        System.out.println();
        ...
        System.out.println(Arrays.toString(Problem3.mul(t1, f)));
        System.out.println();

//      Problem3.divv( new int[]{1,3,4,5}, myInt);
        int i = 2;
        System.out.printf("t1 / %d = ", i);
        System.out.println(Arrays.toString(Problem3.divv(t1, f)));
        System.out.println();

        System.out.println("Maximul din t1 este: ");
//        System.out.println(maxx(new int[]{2,3,5}));
        System.out.println(Problem4.maxx(t1));

        System.out.println();

        System.out.println("Cea mai mare valoare din [40, 50, 60] si [5 12] este:");
//        System.out.println(Problem4.most_expensive(t1, t2));
        System.out.println(Problem4.most_expensive(new int[]{40, 50, 60}, new int[]{5, 12}));

        System.out.println();

        int buget = 50;
        int rez = (Problem4.in_budget(new int[]{15,45,20}, buget));
...
//         System.out.println("dc intai afiseaza asta si abia la finalul executiei programului trace ul din catch??");
        ...
        int[] res = Problem4.ex4(60, new int[] {40, 50, 60}, new int[]{8, 9, 12});
